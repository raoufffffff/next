...
export const OrderSummary = ({ freeDelivery, deliveryCost, total, mainColor, isdegitalproduct
}: Props) => (
  <div className="bg-gray-50 p-4 rounded-xl border border-dashed border-gray-300 mt-6">
    {!isdegitalproduct && < div className="flex justify-between items-center text-gray-600 mb-2">
      <span>التوصيل:</span>
